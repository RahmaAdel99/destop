...
public class Xml_signature {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, IOException, SignatureException, InvalidKeyException {
        ...
        // Convert SOAP request string to bytes
      //  byte[] soapRequestBytes = soapRequest.getBytes(StandardCharsets.UTF_8);
        ...
        System.out.println("signature1 : "  + Base64.getEncoder().encodeToString(digitalSignature));

        System.out.println("signature2 : "  + verified);

        System.out.println("signature2 : "  + verificationSignature);
    }
